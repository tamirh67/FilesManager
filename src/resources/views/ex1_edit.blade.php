...
@section('content')
    ...
    <div class="row " style="margin-top: 5px;">
        {!! Form::open(array('url' => '/ex1update', 'class' => '', 'method' => 'post')) !!}
        {!! Form::label('name', 'Edit ex1 object' ) !!}
        <input name="mediaable_type" type="hidden"  value="exObj1"/>
    ...
    <div>
        <table class="table table-striped table-bordered" style="margin-top: 0px;">
            ...
            @foreach ($theDocuments as $aDocument)
                <tr>
                    <td style="vertical-align:middle"><a class="popup-link" href="/media/show/{{$aDocument->id}}"><img class="" src="{{$aDocument->thumbsUrl}}" alt=""></a></td>
                    <td style="vertical-align:middle">
                        <a class="popup-link" href="/media/show/{{$aDocument->id}}">{{$aDocument->displayname}}</a>
                    </td>
                    ...
                    <td style="vertical-align:middle">
                        ...
                        <input name="mediaable_type" type="hidden" value="App\ex1Obj">
